	...
	function i(r, t, e) {
		...
		1 === n || 2 === n ? function(r, t, e) {
			...
			var a = i.measureText(e.label).width,
				...
				l = c + f,
				h = s + u;
			1 === e.mode ? r.addBlank(0, s - .01, n, h + .01) : r.addBlank(c - .01, s - .01, .01 + l, h + .01), t.fillStyle = e
			...
			var n = e.size,
				...
				s = f + u,
				l = c + a;
			3 === e.mode ? r.addBlank(0, c - .01, n, l + .01) : r.addBlank(f - .01, c - .01, .01 + s, l + .01), t.drawImage(e.image,
				f * n, c * n, u * n, a * n)
		}(r, t, e)
	}
		...
		return i(e, o, t),
			function(r, t, e) {
				...
				if (d(e.fill).is("img")) {
					...
					t.globalCompositeOperation = "destination-out", t.fill(), t.globalCompositeOperation = f, t.clip(), t.drawImage(e.fill,
	...
	var r, t = function() {
			...
			var t = function() {
				...
				i = {
					...
					mod: function(r) {
						...
						for (var t = b.glog(i.getAt(0)) - b.glog(r.getAt(0)), e = new Array(i.getLength()), n = 0; n < i.getLength(); n +=
							1) e[n] = i.getAt(n);
		...
		function o(r, t) {
			function o(r, t) {
				s = function(r) {
					...
					return t
				}(l = 4 * u + 17), i(0, 0), i(l - 7, 0), i(0, l - 7), h(), c(), d(r, t), 7 <= u && g(r), null == e && (e = p(u,
					a, n)), v(e, t)
			}
			var u = r,
				a = m[t],
				...
				i = function(r, t) {
					for (var e = -1; e <= 7; e += 1)
						if (!(r + e <= -1 || l <= r + e))
							for (var n = -1; n <= 7; n += 1) t + n <= -1 || l <= t + n || (s[r + e][t + n] = 0 <= e && e <= 6 && (0 == n ||
								6 == n) || 0 <= n && n <= 6 && (0 == e || 6 == e) || 2 <= e && e <= 4 && 2 <= n && n <= 4)
				},
				c = function() {
				...
				h = function() {
					for (var r = T.getPatternPosition(u), t = 0; t < r.length; t += 1)
						for (var e = 0; e < r.length; e += 1) {
							...
							if (null == s[n][o])
								for (var i = -2; i <= 2; i += 1)
									for (var a = -2; a <= 2; a += 1) s[n + i][o + a] = -2 == i || 2 == i || -2 == a || 2 == a || 0 == i && 0 ==
										a
						}
				},
				g = function(r) {
					...
					for (var e = -1, n = l - 1, o = 7, i = 0, a = T.getMaskFunction(t), u = l - 1; 0 < u; u -= 2)
						for (6 == u && (u -= 1);;) {
							for (var f = 0; f < 2; f += 1)
								if (null == s[n][u - f]) {
									var c = !1;
									i < r.length && (c = 1 == (r[i] >>> o & 1)), a(n, u - f) && (c = !c), s[n][u - f] = c, -1 == (o -= 1) && (i +=
										1, o = 7)
								} if ((n += e) < 0 || l <= n) {
								n -= e, e = -e;
								break
			...
			return f.addData = function(r) {
				...
				for (var n = 0; n < f.getModuleCount(); n += 1) {
					...
					for (var o = 0; o < f.getModuleCount(); o += 1) e += '<td style="', e +=
						...
						" background-color: ", e += f.isDark(n, o) ? "#000000" : "#ffffff", e += ";", e += '"/>';
					e += "</tr>"
				}
		...
		function h(r, t) {
			var n = r,
				...
				e = {
					...
					write: function(r) {
						r.writeString("GIF87a"), r.writeShort(n), r.writeShort(o), r.writeByte(128), r.writeByte(0), r.writeByte(0), r
							.writeByte(0), r.writeByte(0), r.writeByte(0), r.writeByte(255), r.writeByte(255), r.writeByte(255), r.writeString(
								","), r.writeShort(0), r.writeShort(0), r.writeShort(n), r.writeShort(o), r.writeByte(0);
						var t = i(2);
						r.writeByte(2);
				...
				i = function(r) {
					...
					for (f += 1; f < l.length;) {
						...
						f += 1, o.contains(c + s) ? c += s : (u.write(o.indexOf(c), n), o.size() < 4095 && (o.size() == 1 << n && (n +=
							1), o.add(c + s)), c = s)
					}
		...
		var d, r, t, e, n = 1,
			...
			T = (t = [
				...
				for (var t = r.getModuleCount(), e = 0, n = 0; n < t; n += 1)
					for (var o = 0; o < t; o += 1) {
						for (var i = 0, a = r.isDark(n, o), u = -1; u <= 1; u += 1)
							if (!(n + u < 0 || t <= n + u))
								for (var f = -1; f <= 1; f += 1) o + f < 0 || t <= o + f || 0 == u && 0 == f || a != r.isDark(n + u, o + f) ||
									(i += 1);
						5 < i && (e += 3 + i - 5)
					}
				for (n = 0; n < t - 1; n += 1)
				...
				for (n = 0; n < t; n += 1)
					for (o = 0; o < t - 6; o += 1) r.isDark(n, o) && !r.isDark(n, o + 1) && r.isDark(n, o + 2) && r.isDark(n, o + 3) &&
						r.isDark(n, o + 4) && !r.isDark(n, o + 5) && r.isDark(n, o + 6) && (e += 40);
				for (o = 0; o < t; o += 1)
					for (n = 0; n < t - 6; n += 1) r.isDark(n, o) && !r.isDark(n + 1, o) && r.isDark(n + 2, o) && r.isDark(n + 3, o) &&
						r.isDark(n + 4, o) && !r.isDark(n + 5, o) && r.isDark(n + 6, o) && (e += 40);
				var s = 0;
				for (o = 0; o < t; o += 1)
			...
			C = (d = [
				...
				for (var i = o.length / 3, a = new Array, u = 0; u < i; u += 1)
					for (var f = o[3 * u + 0], c = o[3 * u + 1], s = o[3 * u + 2], l = 0; l < f; l += 1) a.push((e = s, n = void 0,
						(n = {}).totalCount = c, n.dataCount = e, n));
				return a
			}, r),
			B = function() {
				var e = new Array,
			...
			A = function(r, t, e, n) {
				...
				f.flush();
				var l = "";
				return l += "<img", l += ' src="', l += "data:image/gif;base64,", l += f, l += '"', l += ' width="', l += r, l +=
					'"', l += ' height="', l += t, l += '"', n && (l += ' alt="', l += n, l += '"'), l + "/>"
			};
		...
		t.stringToBytes = function(r) {
			return function(r) {
				for (var t = [], e = 0; e < r.length; e++) {
					var n = r.charCodeAt(e);
					n < 128 ? t.push(n) : n < 2048 ? t.push(192 | n >> 6, 128 | 63 & n) : n < 55296 || 57344 <= n ? t.push(224 | n >>
		...
		this.each(function() {
			...
			! function(o, i) {
				...
				f.each(r, function(r, t) {
					...
					n.prop("aria-label", "分享到 " + u[t]), n.prop("href", e), "wechat" === t ? n.prop("tabindex", -1) : n.prop(
						"target", "_blank"), i.initialized || ("prepend" == i.mode ? o.prepend(n) : o.append(n))
				})
			}(t, r),
			function(r, t) {
				...
				e.append('<div class="wechat-qrcode"><h4>' + t.wechatQrcodeTitle +
						'</h4><div class="qrcode"></div><div class="help">' + t.wechatQrcodeHelper + "</div></div>"), e.find(".qrcode")
					.qrcode({
						render: "image",
